...
hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("sh ~/.config/hypr/random_wallpaper.sh")
    hl.exec_cmd("mpg123 ~/.sounds/startup.mp3")
    hl.exec_cmd("swayosd-server")
    -- Special Workspaces Apps
    hl.exec_cmd("flatpak run com.super_productivity.SuperProductivity")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(1d92c2ee)", "rgba(00e0d2aa)"}, angle = 45 },
            inactive_border = "rgba(606090aa)",
        },
...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 2,    bezier = "easeInQuint", style = "slidevert 100%" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 2,    bezier = "easeOutQuint", style = "slidevert 100%" })
...
hl.bind(mainMod .. " + slash", hl.dsp.exec_cmd(emojisel))
...
-- App quick launch
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("discord"))
hl.bind(mainMod .. " + F10", hl.dsp.exec_cmd("obs"))
hl.bind(mainMod .. " + F11", hl.dsp.exec_cmd("keepassxc"))
hl.bind(mainMod .. " + F12", hl.dsp.exec_cmd("speedcrunch"))

-- Window
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen(), { toggle = true, mode = "fullscreen" })

-- Layout
hl.bind(mainMod .. " + period", hl.dsp.layout("colresize +0.05"))
hl.bind(mainMod .. " + comma", hl.dsp.layout("colresize -0.05"))
